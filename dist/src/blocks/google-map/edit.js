...
var GoogleMapEdit = /** @class */ (function (_super) {
    ...
    GoogleMapEdit.prototype.updateMarker = function (update, index) {
        ...
        if (typeof markers[index] != "undefined") {
            setAttributes({
                markers: markers.map(function (marker, i) { return (i == index ? update : marker); })
            });
        }
    };
    // Remove marker
    GoogleMapEdit.prototype.removeMarker = function (index) {
        ...
        if (typeof markers[index]) {
            setAttributes({ markers: markers.filter(function (marker, i) { return index != i; }) });
        }
    };
    // Add marker
        ...
        return (React.createElement(Fragment, null,
            React.createElement(InspectorControls, null,
                React.createElement(PanelBody, { className: "editor-panel-map-settings", title: __("Map"), initialOpen: false },
                    ...
                    React.createElement(BaseControl, { label: __("Coordinates") },
                ...
                React.createElement(PanelBody, { className: "editor-panel-map-settings", title: __("Dimensions"), initialOpen: false },
                    React.createElement(BaseControl, { label: __("Ratio") },
                        React.createElement(PanelRow, null,
                            React.createElement(TextControl, { label: React.createElement("small", null, __("X")), type: "number", value: x, onChange: function (val) { return setAttributes({ x: parseFloat(val) }); } }),
                            React.createElement(TextControl, { label: React.createElement("small", null, __("Y")), type: "number", value: y, onChange: function (val) { return setAttributes({ y: parseFloat(val) }); } }))),
                    ...
                    addMinHeight && (React.createElement(PanelRow, null,
                        ...
                        React.createElement(SelectControl, { value: minHeightUnit, onChange: function (val) { return setAttributes({ minHeightUnit: val }); }, options: [
                                { value: "cm", label: "cm" },
                                { value: "em", label: "em" },
                                { value: "in", label: "in" },
                                { value: "mm", label: "mm" },
                ...
                React.createElement(PanelBody, { className: "editor-panel-map-settings", title: __("Markers"), initialOpen: false },
                    markers.map(function (marker, index) {
                        ...
                        return (React.createElement(Fragment, null,
                            ...
                            React.createElement(BaseControl, { className: "mb-0", label: __("Coordinates") },
                                React.createElement(PanelRow, null,
                                    React.createElement(TextControl, { label: React.createElement("small", null, __("Latitude")), value: lat, onChange: function (val) {
                                            return _this.updateMarker({
                                                description: description,
